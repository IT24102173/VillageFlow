...
const styles = {
    ...
    card: { width: '100%', maxWidth: '400px', background: 'white', borderRadius: '15px', overflow: 'hidden', boxShadow: '0 10px 25px rgba(0,0,0,0.1)', border: '2px solid #800000' },
    govHeader: { background: '#800000', color: 'white', padding: '20px', textAlign: 'center' },
    ...
    avatarCircle: { width: '100px', height: '100px', borderRadius: '50%', background: '#f8f9fa', border: '3px solid #fbc531', margin: '0 auto 15px', display: 'flex', justifyContent: 'center', alignItems: 'center' },
