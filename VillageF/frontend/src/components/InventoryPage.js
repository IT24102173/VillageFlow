...
// ========== REUSABLE UI COMPONENTS (FILE-SCOPE TO PREVENT REMOUNT) ==========
            ...
            <div style={{
                ...
                <div>
                    <h2 style={{
                        ...
                        <div style={{ backgroundColor: '#800000', padding: '8px', borderRadius: '12px', display: 'inline-flex' }}>
            ...
            <div className="inventory-tabs-row" style={{ display: 'flex', gap: '8px', marginBottom: '24px', borderBottom: '1px solid #e2e8f0', paddingBottom: '12px' }}>
                {[
                    ...
                    <button
                        ...
                        style={{
                            padding: '10px 24px', backgroundColor: activeTab === tab.id ? '#800000' : 'transparent',
                ...
                <div className="inventory-main-grid" style={{ display: 'grid', gridTemplateColumns: '360px 1fr', gap: '28px' }}>
                    <div style={{ backgroundColor: '#fff', padding: '24px', borderRadius: '20px', boxShadow: '0 1px 3px 0 rgba(0,0,0,0.05)', border: '1px solid #e2e8f0' }}>
                        ...
                        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                                ...
                                <select 
                                    style={{
                                        ...
                                        outlineColor: '#800000', fontSize: '13px'
                                    }} 
                            ...
                            {showAdvancedForm && (
                                <>
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                                        ...
                                        <input type="text" style={{ padding: '10px 12px', borderRadius: '10px', border: '1px solid #e2e8f0', outlineColor: '#800000', fontSize: '13px' }} placeholder="e.g., Main Office, Room 101" 
                                            value={formData.location} onChange={(e) => setFormData({...formData, location: e.target.value})} />
                                    </div>
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                                        <label style={{ fontSize: '12px', fontWeight: '600', color: '#334155' }}><UserIcon size={14} /> Assigned To</label>
                                        <input type="text" style={{ padding: '10px 12px', borderRadius: '10px', border: '1px solid #e2e8f0', outlineColor: '#800000', fontSize: '13px' }} placeholder="Assigned officer name" 
                                    ...
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                                        ...
                                        <select style={{ padding: '10px 12px', borderRadius: '10px', border: '1px solid #e2e8f0', backgroundColor: '#fff', cursor: 'pointer', fontSize: '13px', outlineColor: '#800000' }} value={formData.category} onChange={(e) => setFormData({...formData, category: e.target.value})}>
                                    ...
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                                        ...
                                        <textarea style={{ padding: '10px 12px', borderRadius: '10px', border: '1px solid #e2e8f0', outlineColor: '#800000', fontSize: '13px', minHeight: '60px' }} placeholder="Any notes or damage reports..." 
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                                ...
                                <select style={{ padding: '10px 12px', borderRadius: '10px', border: '1px solid #e2e8f0', backgroundColor: '#fff', cursor: 'pointer', fontSize: '13px', outlineColor: '#800000' }} value={formData.condition} onChange={e => setFormData({...formData, condition: e.target.value})}>
                            ...
                            <button type="submit" style={{
                                marginTop: '8px', padding: '12px', backgroundColor: '#800000',
                    ...
                    <div style={{ backgroundColor: '#fff', borderRadius: '20px', overflow: 'hidden', boxShadow: '0 1px 3px 0 rgba(0,0,0,0.05)', border: '1px solid #e2e8f0' }}>
                        <div style={{ padding: '16px 20px', borderBottom: '1px solid #e2e8f0', display: 'flex', alignItems: 'center', gap: '12px', backgroundColor: '#fafafa', flexWrap: 'wrap' }}>
                            ...
                            <select style={{ padding: '10px 12px', borderRadius: '10px', border: '1px solid #e2e8f0', backgroundColor: '#fff', cursor: 'pointer', fontSize: '13px', outlineColor: '#800000', width: 'auto', marginLeft: 'auto' }} value={filterType} onChange={(e) => { setFilterType(e.target.value); setFilterValue(''); }}>
            ...
            <InventoryModal isOpen={showBorrowModal} onClose={() => { setShowBorrowModal(false); setSelectedAssetForBorrow(null); resetBorrowForm(); }} title={`Borrow Asset: ${selectedAssetForBorrow?.itemName || ''}`} width="500px">
                <form onSubmit={handleBorrowRequest}>
                    ...
                    <div style={{ padding: '12px 20px' }}>
                        ...
                        <textarea 
                            style={{ width: '100%', padding: '10px 12px', borderRadius: '10px', border: '1px solid #e2e8f0', outlineColor: '#800000', fontSize: '13px', minHeight: '60px', boxSizing: 'border-box' }} 
                    ...
                    <div style={{ padding: '12px 20px' }}>
                        ...
                        <textarea 
                            style={{ width: '100%', padding: '10px 12px', borderRadius: '10px', border: '1px solid #e2e8f0', outlineColor: '#800000', fontSize: '13px', minHeight: '50px', boxSizing: 'border-box' }} 
                    ...
                    <div style={{ display: 'flex', gap: '12px', padding: '20px', borderTop: '1px solid #e2e8f0' }}>
                        ...
                        <button type="submit" style={{ flex: 1, padding: '12px', border: 'none', borderRadius: '12px', backgroundColor: '#800000', color: '#fff', cursor: 'pointer', fontWeight: '500' }} disabled={isLoading}>{isLoading ? "Submitting..." : "Submit Request"}</button>
                    </div>
                </form>
            </InventoryModal>
            ...
            <InventoryModal isOpen={showConfirm} onClose={() => setShowConfirm(false)} title="Confirm Deletion" width="400px">
                <div style={{ textAlign: 'center', padding: '20px' }}>
                    ...
                    <div style={{ display: 'flex', gap: '12px' }}>
                        ...
                        <button onClick={confirmDelete} style={{ flex: 1, padding: '12px', border: 'none', borderRadius: '12px', backgroundColor: '#800000', color: '#fff', cursor: 'pointer', fontWeight: '500' }} disabled={isLoading}>Delete Asset</button>
                    </div>
                </div>
            </InventoryModal>
        </div>
