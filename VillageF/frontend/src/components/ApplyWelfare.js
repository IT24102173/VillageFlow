...
function ApplyWelfare() {
    ...
    const loadUserApplications = useCallback(async () => {
        ...
        setLoading(true);
        try {
            const response = await axios.get(`http://localhost:5000/api/welfare/user-applications/${user._id}`);
    ...
    const handleApply = async (e) => {
        ...
        try {
            await axios.post('http://localhost:5000/api/welfare/apply', formData, {
    ...
    const handleEditSubmit = async (e) => {
        ...
        try {
            await axios.put(`http://localhost:5000/api/welfare/user-edit/${editingId}`, formData, {
                headers: { 'Content-Type': 'multipart/form-data' }
            });
    ...
    const handleDelete = async (id) => {
        ...
        try {
            await axios.delete(`http://localhost:5000/api/welfare/user-delete/${id}`, {
    ...
    return (
        <div className="welfare-page-wrapper" style={styles.pageBackground}>
            <div className="welfare-container" style={styles.container}>
                {/* Language Selector */}
                <div className="welfare-lang-bar" style={styles.langBar}>
                ...
                {/* Main Form Card */}
                <div className="welfare-card" style={styles.card}>
                    <h2 style={styles.title}>{editingId ? t.editApplication : t.title}</h2>
                    <p className="subtitle" style={styles.subtitle}>{t.subtitle}</p>

                    {success && (
                        <div className="success-msg" style={styles.successMsg}>
                    ...
                    <form onSubmit={editingId ? handleEditSubmit : handleApply} className="welfare-form" style={styles.form}>
                        <div className="form-field" style={styles.inputGroup}>
                        ...
                        {!editingId && (
                            <div className="form-field" style={styles.inputGroup}>
                                ...
                                <small className="hint-text" style={styles.hintText}>
                        ...
                        {welfareSettings.incomeVerificationRequired && (
                            <div className="form-field" style={styles.inputGroup}>
                                ...
                                <small className="optional-note" style={styles.optionalNote}>
                                    {isPaySlipRequired() 
                        ...
                        {!editingId && (
                            <div className="verify-box" style={styles.verifyBox}>
                                <ShieldCheck size={18} color="#800000" />
                                <span className="verify-text" style={styles.verifyText}>
                ...
                <div className="applications-card" style={styles.applicationsCard}>
                    ...
                    {loading && initialLoad ? (
                        <div className="loading-container" style={styles.loadingContainer}>
                            ...
                            <p className="loading-text" style={styles.loadingText}>{t.loading}</p>
                        </div>
                        ...
                        <div className="applications-list" style={styles.applicationsList}>
                            {userApplications.map(app => (
                                <div key={app._id} className="application-item" style={styles.applicationItem}>
                                    <div className="application-header" style={styles.applicationHeader}>
                                        <div>
                                            <h4 className="app-name" style={styles.appName}>{app.fullName}</h4>
                                            <p className="app-type" style={styles.appType}>{app.type}</p>
                                        </div>
                                        <span style={{
                                            ...styles.statusBadge,
                                    ...
                                    <div className="application-details" style={styles.applicationDetails}>
                                        <p className="detail-item" style={styles.detailItem}>
                                    ...
                                    {app.status === 'Pending' && (
                                        <div className="application-actions" style={styles.applicationActions}>
                                            <button 
