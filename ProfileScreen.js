...
import { 
  User, Edit3, Save, X as CloseIcon, LogOut, Landmark, MapPin, 
  Phone, Calendar, Mail, Briefcase, Home, Shield, Smartphone, FileText, UserPlus, Award,
  Download, AlertCircle, Clock, Trash2
...
export default function ProfileScreen({ navigation }) {
    ...
    const downloadSmartID = async () => {
        try {
            setSaving(true);
            const qrValue = `https://villageflow.onrender.com/api/auth/user/${userData._id || userData.id}`;
            const htmlContent = `
                <html>
                <head>
                    <style>
                ...
                { 
                    ...
                    onPress: async () => {
                        try {
                            ...
                            Alert.alert("Error", "Delete failed. Please contact support.");
                        }
                    } 
                }
            ]
    ...
    return (
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.idCard}>
                    ...
                    <View style={styles.qrContainer}>
                        <QRCode
                            ...
                            value={`https://villageflow.onrender.com/api/auth/user/${userData._id || userData.id}`}
                            size={140}
                            color="black"
                ...
                <TouchableOpacity style={[styles.logoutBtn, {marginTop: 0, opacity: 0.7}]} onPress={handleDeleteAccount}><Trash2 size={20} color="#ef4444" /><Text style={[styles.logoutText, {color: '#ef4444'}]}>{t.delete}</Text></TouchableOpacity>
            </ScrollView>
...
const styles = StyleSheet.create({
    ...
    headerSub: { color: '#fda4af', fontSize: 12 },
    ...
    termsText: { fontSize: 13, color: '#64748b', marginLeft: 10, flex: 1 },
