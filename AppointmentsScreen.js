...
import { 
  ...
  Clock, X as CloseIcon, Check, Search, Info, User, ChevronRight, AlertCircle,
                        ...
                        <View style={styles.actionGroup}>
                            {item.status === 'Pending' && (
                                <>
                                    ...
                                    <TouchableOpacity style={[styles.actionBtn, styles.rejectBtn]} onPress={() => handleStatusUpdate(item._id, 'Rejected')}><CloseIcon size={16} color="#fff" /><Text style={styles.btnLabel}>Reject</Text></TouchableOpacity>
                                </>
                            )}
            ...
            {isOfficer && (
                <View style={styles.filterBar}>
                    {['All', 'Pending', 'Approved', 'Rejected'].map(f => (
                        <TouchableOpacity key={f} onPress={() => setStatusFilter(f)} style={[styles.filterChip, statusFilter === f && styles.filterBtnActive]}>
            ...
            <Modal visible={showForm} animationType="slide" presentationStyle="pageSheet">
                <View style={styles.modalBody}>
                    <View style={styles.modalTop}>
                        ...
                        <TouchableOpacity style={styles.closeBtn} onPress={resetForm}><CloseIcon size={24} color="#64748b" /></TouchableOpacity>
                    </View>
...
const styles = StyleSheet.create({
    ...
    filterBtnActive: { backgroundColor: '#800000', borderColor: '#800000' },
