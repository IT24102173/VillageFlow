...
const translations = {
    en: {
        ...
        contact: "Contact Number", hours: "Office Hours", officeAddress: "Office Address",
    ...
    si: {
        ...
        contact: "දුරකථන අංකය", hours: "වේලාවන්", officeAddress: "කාර්යාල ලිපිනය",
    ...
    ta: {
        title: "அமைப்பு கட்டமைப்பு", sub: "உலகளாவிய கிராம அமைப்புகள்",
        general: "அலுவலக தகவல்", appoint: "சந்திப்புகள்", welfare: "நலன்புரி விதிகள்",
        save: "மாற்றங்களைச் சேமி", refresh: "புதுப்பி",
        officeName: "கிராம நிலதாரி பெயர்", division: "பிரிவு",
        contact: "தொடர்பு எண்", hours: "அலுவலக நேரம்", officeAddress: "அலுவலக முகவரி",
        maxApp: "அதிகபட்ச சந்திப்புகள்/நாள்", advance: "முன்பதிவு (நாட்கள்)",
        services: "சேவைகள் & காலம்", holidays: "பொது விடுமுறை",
        incomeReq: "வருமான ஆதாரம் தேவை", maxWelfare: "அதிகபட்ச நலன்புரி/மாதம்",
        success: "அமைப்புகள் சேமிக்கப்பட்டன", error: "சேமிக்க முடியவில்லை",
        add: "புதியதைச் சேர்", delete: "நீக்கு"
    }
};
                ...
                {activeTab === 'general' && (
                    <View style={styles.section}>
                        ...
                        <View style={styles.inputGroup}>
                            ...
                            <TextInput style={styles.input} value={config.general?.officeAddress} onChangeText={v => updateField('general', 'officeAddress', v)} multiline />
                        </View>
                    </View>
                )}
...
const styles = StyleSheet.create({
    ...
    langSwitch: { flexDirection: 'row', backgroundColor: 'rgba(255,255,255,0.1)', borderRadius: 10, padding: 2, marginRight: 10 },
